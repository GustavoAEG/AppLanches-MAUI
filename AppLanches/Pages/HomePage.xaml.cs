...
public partial class HomePage : ContentPage
{
    ...
    {
        var currentSelection = e.CurrentSelection.FirstOrDefault() as Categoria; //selecionar item selecionado na categoria...

        if (currentSelection is null) return;

        Navigation.PushAsync(new ListaProdutoPage(currentSelection.Id,currentSelection.Nome!,_apiService,_validator));
